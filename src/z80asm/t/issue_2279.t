...
ASM
    ...
    z80asm_ok( "-mez80_z80$strict -b -l",
        "", "", <<ASM, bytes( 2, 4, 6, 7, 9 ) );
		ifdef __CPU_EZ80${STRICT}__ 	: defb 1 : endif
		ifdef __CPU_EZ80_Z80${STRICT}__ : defb 2 : endif
...
ASM
    ...
    z80asm_ok( "-mez80_z80$strict -b -l",
        "", "", <<ASM, bytes( 0xCD, 0x56, 0x34 ) );
		call 0x123456
ASM

    z80asm_ok( "-mez80$strict -b -l",
        "", "", <<ASM, bytes( 0xCD, 0x56, 0x34, 0x12 ) );
		call 0x123456
ASM

    z80asm_ok( "-mez80$strict -b -l",
        "", "", <<ASM, bytes( 0xCD, 0x56, 0x34, 0xCD, 0x56, 0x34, 0x12 ) );
		.ASSUME ADL=0
		call 0x123456
		.ASSUME ADL=1
		call 0x123456
