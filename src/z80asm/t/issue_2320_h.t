...
capture_ok( "z88dk-z80asm -v -x$test.lib -mz80 " . quote_os("$test.*.asm"),
    <<END );
% z88dk-z80asm -v -xtest_t_issue_2320_h_t.lib -mz80 ${\os_quoted("test_t_issue_2320_h_t.*.asm")}
Predefined constant: __CPU_Z80__ = 1
Predefined constant: __CPU_ZILOG__ = 1
Predefined constant: __FLOAT_GENMATH__ = 1
Reading library 'z88dk-z80asm.lib'
Assembling 'test_t_issue_2320_h_t.a.asm'
Writing object file 'test_t_issue_2320_h_t.a.o'

Assembling 'test_t_issue_2320_h_t.b.asm'
Writing object file 'test_t_issue_2320_h_t.b.o'

Creating library 'test_t_issue_2320_h_t.lib'
Adding test_t_issue_2320_h_t.a.o to library
Adding test_t_issue_2320_h_t.b.o to library
END

capture_ok( "z88dk-z80nm -a $test.lib", <<'END' );
Library file test_t_issue_2320_h_t.lib at $0000: Z80LMF18
Object  file test_t_issue_2320_h_t.lib at $0014: Z80RMF18
  Name: test_t_issue_2320_h_t.a
  CPU:  z80 
  Section "": 0 bytes
