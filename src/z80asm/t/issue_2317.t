...
check_bin_file( "$test-1.bin",
    bytes( 0x05, 0xc2, 0x00, 0x00, 0x05, 0xc2, 0x04, 0x00 ) );
...
check_bin_file( "$test-1.bin", bytes( 0x05, 0x20, 0xfd, 0x05, 0x20, 0xfd ) );
...
check_bin_file( "$test-1.bin",
    bytes( 0x76, 0x10, 0xfd, 0x76, 0x10, 0xfd, 0x10, 0xf8, 0x10, 0xfe ) );
