...
for my $ident (qw( a_123 _123 a123 )) {
    for my $eq ( '', '=' ) {
        z80asm_ok( "-b -D${eq}${ident}",
            "", "", "ld a, $ident", bytes( 0x3E, 0x01 ) );
    }
}
...
delete $ENV{TEST_ENV};
z80asm_ok(
    "-b " . quote_os("-D_value\${TEST_ENV}23"),
    "", "",
    "ld a,_value23",
    bytes( 0x3E, 0x01 )
);
...
capture_ok(
    "z88dk-z80asm -v "
        . "-Dmten=-+-+-10 -Dmnine=-9 -Dzero=0 -Done -Dnine=+9 -Dten=10 ${test}.asm",
    <<'END' );
% z88dk-z80asm -v -Dmten=-+-+-10 -Dmnine=-9 -Dzero=0 -Done -Dnine=+9 -Dten=10 test_t_option_define_t.asm
...
Assembling 'test_t_option_define_t.asm'
Writing object file 'test_t_option_define_t.o'
