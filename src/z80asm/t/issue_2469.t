...
capture_ok(
"z88dk-z80asm -mz80n -b -m -o$test.bin -DFAIL_TEST t/2469/SpriteData_Boulder.asm t/2469/SpriteData_Boulder2.asm",
    ""
);
...
capture_ok(
"z88dk-z80asm -mz80n -b -m -o$test.bin t/2469/SpriteData_Boulder.asm t/2469/SpriteData_Boulder2.asm",
    ""
);
%map = read_map_file("$test.map");
is $map{_Boulder2PalettePage},  0x0037;
