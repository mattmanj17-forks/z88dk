...
run_ok(
    "z88dk-z80asm -l$test.lib -b -r0x8000 -o$test.bin $test.1.asm $test.2.asm");

check_bin_file(
    "$test.bin",
    bytes(
        0x3e, 0x01, 0xcd, 0x16, 0x80, 0xcd, 0x2c, 0x80, 0xc3, 0x0b,
        0x80, 0x3e, 0x02, 0xcd, 0x21, 0x80, 0xcd, 0x2c, 0x80, 0xc3,
        0x00, 0x80, 0x06, 0x01, 0xcd, 0x00, 0x80, 0xcd, 0x2c, 0x80,
        0xc3, 0x21, 0x80, 0x06, 0x02, 0xcd, 0x0b, 0x80, 0xcd, 0x2c,
        0x80, 0xc3, 0x16, 0x80, 0x2e, 0x01, 0xc3, 0x31, 0x80, 0x2e,
        0x02, 0xc3, 0x2c, 0x80,
    )
);
