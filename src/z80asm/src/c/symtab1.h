...
extern Symbol1* define_global_sym(const char* name, long value,
                                  sym_type_t type);
...
extern Symbol1Hash* select_module_symbols( struct Module1* module,
...
extern void local_labels_reset(void);
