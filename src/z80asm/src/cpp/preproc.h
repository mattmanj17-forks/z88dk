...
public:
    ...
    bool got_error() const {
        return m_error;
    }
    void set_error(bool f) {
        m_error = f;
    }
private:
    bool    m_error{ false };
...
private:
    ...
    Macros& defines() {
        return m_levels.back().defines;
    }
    Macros& defines_base() {
        return m_levels.front().defines;
    }
    ...
    void expand_ident(ExpandedLine& out, const Token& ident, ScannedLine& line,
                      Macros& defines);
    ExpandedLine expand_define_call(const Token& ident, ScannedLine& line,
                                    Macros& defines);
