...
double FloatExpr::parse_primary() {
    ...
    case TType::Ident:
        ...
        case Keyword::SIN:
            m_line->next();
            return parse_func(sin);
        case Keyword::COS:
            m_line->next();
            return parse_func(cos);
        case Keyword::TAN:
            m_line->next();
            return parse_func(tan);
        case Keyword::ASIN:
            m_line->next();
            return parse_func(asin);
        case Keyword::ACOS:
            m_line->next();
            return parse_func(acos);
        case Keyword::ATAN:
            m_line->next();
            return parse_func(atan);
        case Keyword::ATAN2:
            m_line->next();
            return parse_func2(atan2);
        case Keyword::SINH:
            m_line->next();
            return parse_func(sinh);
        case Keyword::COSH:
            m_line->next();
            return parse_func(cosh);
        case Keyword::TANH:
            m_line->next();
            return parse_func(tanh);
        case Keyword::ASINH:
            m_line->next();
            return parse_func(asinh);
        case Keyword::ACOSH:
            m_line->next();
            return parse_func(acosh);
        case Keyword::ATANH:
            m_line->next();
            return parse_func(atanh);
        case Keyword::LOG:
            m_line->next();
            return parse_func(log);
        case Keyword::LOG10:
            m_line->next();
            return parse_func(log10);
        case Keyword::LOG2:
            m_line->next();
            return parse_func(log2);
        case Keyword::EXP:
            m_line->next();
            return parse_func(exp);
        case Keyword::EXP2:
            m_line->next();
            return parse_func(exp2);
        case Keyword::POW:
            m_line->next();
            return parse_func2(pow);
        case Keyword::SQRT:
            m_line->next();
            return parse_func(sqrt);
        case Keyword::CBRT:
            m_line->next();
            return parse_func(cbrt);
        case Keyword::CEIL:
            m_line->next();
            return parse_func(ceil);
        case Keyword::FLOOR:
            m_line->next();
            return parse_func(floor);
        case Keyword::TRUNC:
            m_line->next();
            return parse_func(trunc);
        case Keyword::ABS:
            m_line->next();
            return parse_func(abs);
        case Keyword::HYPOT:
            m_line->next();
            return parse_func2(hypot);
        case Keyword::FMOD:
            m_line->next();
            return parse_func2(fmod);
        case Keyword::PI:
            m_line->next();
            return atan(1) * 4;
        case Keyword::E:
