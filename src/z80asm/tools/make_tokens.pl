...
my @tokens = (
    ...
    # Flags
    'CALL_NZ', 'CALL_Z', 'CALL_NC', 'CALL_C', 'CALL_PO', 'CALL_PE', 'CALL_P',
    'CALL_M',
    'CALL_LZ', 'CALL_LO', 'CALL_NV', 'CALL_V', 'CALL_NK', 'CALL_K', 'CALL_NX5',
    'CALL_X5',
    'CALL_NE',  'CALL_EQ',
    ...
    'CALL3_NZ',  'CALL3_Z', 'CALL3_NC', 'CALL3_C', 'CALL3_PO', 'CALL3_PE',
    'CALL3_P',   'CALL3_M',
    'CALL3_LZ',  'CALL3_LO', 'CALL3_NV', 'CALL3_V', 'CALL3_NK', 'CALL3_K',
    'CALL3_NX5', 'CALL3_X5',
    'CALL3_NE',  'CALL3_EQ',
    ...
    'CALL_SIS_NZ',  'CALL_SIS_Z',   'CALL_SIS_NC', 'CALL_SIS_C', 'CALL_SIS_PO',
    'CALL_SIS_PE',  'CALL_SIS_P',   'CALL_SIS_M',
    'CALL_SIS_LZ',  'CALL_SIS_LO',  'CALL_SIS_NV', 'CALL_SIS_V', 'CALL_SIS_NK',
    'CALL_SIS_K',   'CALL_SIS_NX5', 'CALL_SIS_X5',
    ...
    'CALL_SIL_NZ',  'CALL_SIL_Z',   'CALL_SIL_NC', 'CALL_SIL_C', 'CALL_SIL_PO',
    'CALL_SIL_PE',  'CALL_SIL_P',   'CALL_SIL_M',
    'CALL_SIL_LZ',  'CALL_SIL_LO',  'CALL_SIL_NV', 'CALL_SIL_V', 'CALL_SIL_NK',
    'CALL_SIL_K',   'CALL_SIL_NX5', 'CALL_SIL_X5',
    ...
    'CALL_LIS_NZ',  'CALL_LIS_Z',   'CALL_LIS_NC', 'CALL_LIS_C', 'CALL_LIS_PO',
    'CALL_LIS_PE',  'CALL_LIS_P',   'CALL_LIS_M',
    'CALL_LIS_LZ',  'CALL_LIS_LO',  'CALL_LIS_NV', 'CALL_LIS_V', 'CALL_LIS_NK',
    'CALL_LIS_K',   'CALL_LIS_NX5', 'CALL_LIS_X5',
    ...
    'CALL_LIL_NZ',  'CALL_LIL_Z',   'CALL_LIL_NC', 'CALL_LIL_C', 'CALL_LIL_PO',
    'CALL_LIL_PE',  'CALL_LIL_P',   'CALL_LIL_M',
    'CALL_LIL_LZ',  'CALL_LIL_LO',  'CALL_LIL_NV', 'CALL_LIL_V', 'CALL_LIL_NK',
    'CALL_LIL_K',   'CALL_LIL_NX5', 'CALL_LIL_X5',
    ...
    'CALL_IS_NZ',  'CALL_IS_Z',   'CALL_IS_NC', 'CALL_IS_C', 'CALL_IS_PO',
    'CALL_IS_PE',  'CALL_IS_P',   'CALL_IS_M',
    'CALL_IS_LZ',  'CALL_IS_LO',  'CALL_IS_NV', 'CALL_IS_V', 'CALL_IS_NK',
    'CALL_IS_K',   'CALL_IS_NX5', 'CALL_IS_X5',
    'CALL_IS_NE',  'CALL_IS_EQ',
    'CALL_IS_LTU', 'CALL_IS_LEU', 'CALL_IS_GTU', 'CALL_IS_GEU',
    'CALL_IS_LT',  'CALL_IS_LE',  'CALL_IS_GT',  'CALL_IS_GE',
    'CALL_IS_OF',

    'CALL_IL_NZ',  'CALL_IL_Z',   'CALL_IL_NC', 'CALL_IL_C', 'CALL_IL_PO',
    'CALL_IL_PE',  'CALL_IL_P',   'CALL_IL_M',
    'CALL_IL_LZ',  'CALL_IL_LO',  'CALL_IL_NV', 'CALL_IL_V', 'CALL_IL_NK',
    'CALL_IL_K',   'CALL_IL_NX5', 'CALL_IL_X5',
    ...
    'JRE_LZ', 'JRE_LO', 'JRE_NV', 'JRE_V', 'JRE_NK', 'JRE_K',  'JRE_NX5',
    'JRE_X5',
    'JRE_NE',  'JRE_EQ',
    ...
    'LLJP_NZ', 'LLJP_Z', 'LLJP_NC', 'LLJP_C', 'LLJP_PO', 'LLJP_PE', 'LLJP_P',
    'LLJP_M',
    'LLJP_LZ', 'LLJP_LO', 'LLJP_NV', 'LLJP_V', 'LLJP_NK', 'LLJP_K', 'LLJP_NX5',
    'LLJP_X5',
    'LLJP_NE',  'LLJP_EQ',
    ...
    'JP3_LZ', 'JP3_LO', 'JP3_NV', 'JP3_V', 'JP3_NK', 'JP3_K',  'JP3_NX5',
    'JP3_X5',
    'JP3_NE',  'JP3_EQ',
    ...
    'JP_SIS_NZ',  'JP_SIS_Z', 'JP_SIS_NC', 'JP_SIS_C', 'JP_SIS_PO', 'JP_SIS_PE',
    'JP_SIS_P',   'JP_SIS_M',
    'JP_SIS_LZ',  'JP_SIS_LO', 'JP_SIS_NV', 'JP_SIS_V', 'JP_SIS_NK', 'JP_SIS_K',
    'JP_SIS_NX5', 'JP_SIS_X5',
    'JP_SIS_NE',  'JP_SIS_EQ',
    'JP_SIS_LTU', 'JP_SIS_LEU', 'JP_SIS_GTU', 'JP_SIS_GEU',
    'JP_SIS_LT',  'JP_SIS_LE',  'JP_SIS_GT',  'JP_SIS_GE',
    'JP_SIS_OF',

    'JP_LIL_NZ',  'JP_LIL_Z', 'JP_LIL_NC', 'JP_LIL_C', 'JP_LIL_PO', 'JP_LIL_PE',
    'JP_LIL_P',   'JP_LIL_M',
    'JP_LIL_LZ',  'JP_LIL_LO', 'JP_LIL_NV', 'JP_LIL_V', 'JP_LIL_NK', 'JP_LIL_K',
    'JP_LIL_NX5', 'JP_LIL_X5',
    'JP_LIL_NE',  'JP_LIL_EQ',
    ...
    'JMP_LZ', 'JMP_LO', 'JMP_NV', 'JMP_V', 'JMP_NK', 'JMP_K',  'JMP_NX5',
    'JMP_X5',
    'JMP_NE',  'JMP_EQ',
    ...
    'JMP_SIS_NZ',  'JMP_SIS_Z',   'JMP_SIS_NC', 'JMP_SIS_C', 'JMP_SIS_PO',
    'JMP_SIS_PE',  'JMP_SIS_P',   'JMP_SIS_M',
    'JMP_SIS_LZ',  'JMP_SIS_LO',  'JMP_SIS_NV', 'JMP_SIS_V', 'JMP_SIS_NK',
    'JMP_SIS_K',   'JMP_SIS_NX5', 'JMP_SIS_X5',
    'JMP_SIS_NE',  'JMP_SIS_EQ',
    'JMP_SIS_LTU', 'JMP_SIS_LEU', 'JMP_SIS_GTU', 'JMP_SIS_GEU',
    'JMP_SIS_LT',  'JMP_SIS_LE',  'JMP_SIS_GT',  'JMP_SIS_GE',
    'JMP_SIS_OF',

    'JMP_LIL_NZ',  'JMP_LIL_Z',   'JMP_LIL_NC', 'JMP_LIL_C', 'JMP_LIL_PO',
    'JMP_LIL_PE',  'JMP_LIL_P',   'JMP_LIL_M',
    'JMP_LIL_LZ',  'JMP_LIL_LO',  'JMP_LIL_NV', 'JMP_LIL_V', 'JMP_LIL_NK',
    'JMP_LIL_K',   'JMP_LIL_NX5', 'JMP_LIL_X5',
    ...
    'RET_LZ', 'RET_LO', 'RET_NV', 'RET_V', 'RET_NK', 'RET_K',  'RET_NX5',
    'RET_X5',
    'RET_NE',  'RET_EQ',
    ...
    'RET3_NZ', 'RET3_Z', 'RET3_NC', 'RET3_C', 'RET3_PO', 'RET3_PE', 'RET3_P',
    'RET3_M',
    'RET3_LZ', 'RET3_LO', 'RET3_NV', 'RET3_V', 'RET3_NK', 'RET3_K', 'RET3_NX5',
    'RET3_X5',
    'RET3_NE',  'RET3_EQ',
    ...
    'RET_L_NZ',  'RET_L_Z', 'RET_L_NC', 'RET_L_C', 'RET_L_PO', 'RET_L_PE',
    'RET_L_P',   'RET_L_M',
    'RET_L_LZ',  'RET_L_LO', 'RET_L_NV', 'RET_L_V', 'RET_L_NK', 'RET_L_K',
    'RET_L_NX5', 'RET_L_X5',
    'RET_L_NE',  'RET_L_EQ',
    ...
    'RET_LIS_NZ',  'RET_LIS_Z',   'RET_LIS_NC', 'RET_LIS_C', 'RET_LIS_PO',
    'RET_LIS_PE',  'RET_LIS_P',   'RET_LIS_M',
    'RET_LIS_LZ',  'RET_LIS_LO',  'RET_LIS_NV', 'RET_LIS_V', 'RET_LIS_NK',
    'RET_LIS_K',   'RET_LIS_NX5', 'RET_LIS_X5',
    'RET_LIS_NE',  'RET_LIS_EQ',
    'RET_LIS_LTU', 'RET_LIS_LEU', 'RET_LIS_GTU', 'RET_LIS_GEU',
    'RET_LIS_LT',  'RET_LIS_LE',  'RET_LIS_GT',  'RET_LIS_GE',
    'RET_LIS_OF',

    'RET_LIL_NZ',  'RET_LIL_Z',   'RET_LIL_NC', 'RET_LIL_C', 'RET_LIL_PO',
    'RET_LIL_PE',  'RET_LIL_P',   'RET_LIL_M',
    'RET_LIL_LZ',  'RET_LIL_LO',  'RET_LIL_NV', 'RET_LIL_V', 'RET_LIL_NK',
    'RET_LIL_K',   'RET_LIL_NX5', 'RET_LIL_X5',
    ...
    'FLAG_NZ', 'FLAG_Z', 'FLAG_NC', 'FLAG_C', 'FLAG_PO', 'FLAG_PE', 'FLAG_P',
    'FLAG_M',
    'FLAG_LZ', 'FLAG_LO', 'FLAG_NV', 'FLAG_V', 'FLAG_X5', 'FLAG_NX5', 'FLAG_K',
    'FLAG_NK',
    'FLAG_NE',  'FLAG_EQ',
    ...
    'IND_BC',  'IND_DE', 'IND_HL', 'IND_HL1', 'IND_SP', 'IND_IX', 'IND_IY',
    'IND_HLI', 'IND_HLD',
    ...
    # alternate registers
    'B1', 'C1', 'D1', 'E1', 'H1', 'L1', 'A1', 'F1', 'BC1', 'DE1', 'JK1', 'HL1',
    'AF1',
    ...
    'LEA',   'PEA',   'RSMIX', 'STMIX',
    'INI2',  'INI2R', 'IND2',  'IND2R', 'INIM', 'INIMR', 'INDM', 'INDMR',
    'INIRX', 'INDRX',
    ...
    'LDPIRX',  'LDWS', 'FILL',   'FILLDE', 'MIRROR', 'NEXTREG', 'PIXELDN',
    'PIXELAD',
    ...
    'SLP', 'MLT', 'IN0', 'OUT0', 'OTIM', 'OTIMR', 'OTDM', 'OTDMR', 'TST',
    'TSTIO',

    # EZ80 specific opcodes

    # Rabbit specific opcodes
    'ALTD',   'ALTS', 'ALTSD', 'BOOL', 'IOE', 'IOI', 'IPRES', 'IPSET', 'IDET',
    'LDDSR',  'LDISR',
    ...
    'PLDI',   'PLDIR',  'PLDISR', 'PLSDDR', 'PLSDR', 'PLSIDR', 'PLSIR', 'PUMA',
    'PUMS',
    'RL1REG', 'RL2REG', 'RL3REG', 'RL4REG', 'RL5REG', 'RL6REG', 'RL7REG',
    'RL8REG',
    'RR1REG', 'RR2REG', 'RR3REG', 'RR4REG', 'RR5REG', 'RR6REG', 'RR7REG',
    'RR8REG',
    'SCALL', 'SHAF1', 'SHAF2', 'SHAF3', 'SL1REG', 'SL2REG', 'SL3REG', 'SL4REG',
    'SL5REG',
    'SL6REG', 'SL7REG', 'SL8REG', 'SR1REG', 'SR2REG', 'SR3REG', 'SR4REG',
    'SR5REG',
    ...
    'RLZ',  'RP',  'RM',   'R_NC', 'R_C', 'R_NZ', 'R_Z', 'R_PO', 'R_PE', 'R_NV',
    'R_V',
    ...
    'ANX',   'ANDL', 'ANDM', 'ORX', 'ORL', 'ORM', 'XRX', 'XORL', 'XORM',
    'DCMP',  'CPC',
    'PCHL1', 'SPHL1', 'XTHL1',
    'JOF',   'J_OF',  'OF',
    'SMF0',  'SMF1',
